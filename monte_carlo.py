...
def run_monte_carlo(num_simulations, initial_capital, max_rounds, win_prob, payout=1, strategy_func=strategies.strategy_flat):
    ...
    for i in range(num_simulations):
        r, t, c = simulate_roulette_session(initial_capital, max_rounds, win_prob, payout, strategy_func)
        ruin_indicator[i] = r
        rounds_played[i] = t
        final_capital[i] = c
